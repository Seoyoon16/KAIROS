...
Adafruit_MPU6050 mpu; // 객체 초기화

/* Create new sensor events */
sensors_event_t a, g, temp; // a: acceleration, g: gyroscope, temp: temperature, sensors_event_t: variable type
void setup(void) { // return값 없음
  Serial.begin(115200);
  while (!Serial) // Serial 응답이 없으
